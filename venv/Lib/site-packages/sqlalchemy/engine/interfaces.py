    ...
    * connectivity plugins such as proxies
    ...
    in the URL::
        ...
        engine = create_engine(
          ...
          "tests?plugin=plugin_one&plugin=plugin_twp&plugin=plugin_three")
    ...
    following::
        ...
        engine = create_engine(
          "mysql+pymysql://scott:tiger@localhost/"
          "tests?plugin=myplugin&my_argument_one=foo&my_argument_two=bar",
