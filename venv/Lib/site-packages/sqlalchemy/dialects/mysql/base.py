...
in the URL, such as::
    ...
    e = create_engine(
        "mysql+pymysql://scott:tiger@localhost/tests?charset=utf8")
...
as the client DBAPI, as in::
    ...
    e = create_engine(
        "mysql+pymysql://scott:tiger@localhost/tests?charset=utf8mb4")
...
``str`` type or ``bytes`` type, with data in the configured charset::
    ...
    e = create_engine(
        "mysql+mysqldb://scott:tiger@localhost/tests?charset=utf8&use_unicode=0")
