...
class TestOldIssues(base.PyMySQLTestCase):
    ...
    def test_issue_6(self):
        ...
        # ToDo: this tests requires access to db 'mysql'.
    ...
    def test_issue_8(self):
        ...
        c.execute("""CREATE TABLE `tests` (`station` int(10) NOT NULL DEFAULT '0', `dh`
datetime NOT NULL DEFAULT '2015-01-01 00:00:00', `echeance` int(1) NOT NULL
DEFAULT '0', `me` double DEFAULT NULL, `mo` double DEFAULT NULL, PRIMARY
KEY (`station`,`dh`,`echeance`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;""")
        try:
            self.assertEqual(0, c.execute("SELECT * FROM tests"))
            c.execute("ALTER TABLE `tests` ADD INDEX `idx_station` (`station`)")
            self.assertEqual(0, c.execute("SELECT * FROM tests"))
        finally:
...
class TestNewIssues(base.PyMySQLTestCase):
    ...
    @unittest2.skip("This tests requires manual intervention")
    ...
    def test_issue_36(self):
        ...
        try:
            # Wait since Travis-CI sometimes fail this tests.
            time.sleep(0.1)
