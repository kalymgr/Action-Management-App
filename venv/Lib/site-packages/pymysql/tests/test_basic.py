...
class TestConversion(base.PyMySQLTestCase):
    ...
    def test_string(self):
        ...
        test_value = "I am a tests string"
        try:
    ...
    def test_untyped(self):
        """ tests conversion of null, empty string """
        conn = self.connections[0]
        c = conn.cursor()
    ...
    def test_datetime_microseconds(self):
        """ tests datetime conversion w microseconds"""
...
class TestCursor(base.PyMySQLTestCase):
    # this tests case does not work quite right yet, however,
