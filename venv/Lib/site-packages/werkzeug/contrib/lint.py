...
class LintMiddleware(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI flaskr required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI flaskr allowed'),
                 stacklevel=2)
