...
def do_select(*args, **kwargs):
    """Filters a sequence of objects by applying a tests to each object,
    and only selecting the objects with the tests succeeding.

    If no tests is specified, each object will be evaluated as a boolean.
...
def do_reject(*args, **kwargs):
    """Filters a sequence of objects by applying a tests to each object,
    and rejecting the objects with the tests succeeding.
...
def do_selectattr(*args, **kwargs):
    """Filters a sequence of objects by applying a tests to the specified
    attribute of each object, and only selecting the objects with the
    tests succeeding.

    If no tests is specified, the attribute's value will be evaluated as
    a boolean.
...
def do_rejectattr(*args, **kwargs):
    """Filters a sequence of objects by applying a tests to the specified
    attribute of each object, and rejecting the objects with the tests
    succeeding.
